...
/**
 * Esta clase representa la interfaz de selección del idioma.
 * Permite al usuario seleccionar entre inglés y español para la interfaz de usuario.
 * Dependiendo del idioma seleccionado, redirige a la interfaz correspondiente.
 * Esta clase es el punto de entrada para el programa.
 */
public class IDIOMA extends javax.swing.JFrame {
  /**
     * Crea una nueva instancia de la clase IDIOMA.
     */   
    public IDIOMA() {
        initComponents();
    }
...
/**
   ...
   /**
     ...
     * Crea una instancia de la clase IDIOMA y la hace visible para el usuario.
