...
public class CAJERO_EN extends javax.swing.JFrame {
    ...
    public CAJERO_EN() {
        ...
        modelMovimientos.addColumn("ACCOUNT");
        modelMovimientos.addColumn("DATE");
    ...
    private void manejarSeleccionOpcion(String mensaje, boolean depositar, boolean retirar, boolean consultarSaldo, boolean transferir, boolean cambiarContraseña) {
        ...
        habilitarBotonesPrincipales(false);
        if (opcionDepositar || opcionRetirar || opcionTransferir) {
    ...
    private void initComponents() {
        ...
        jpanel_seleccion.add(jlb_movTipoCuneta, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 10, 80, 30));
        ...
        jLabel5.setText("THE ACCOUNT BALANCE IS:");
        ...
        btn_ConsultarSaldo.setText("CHECK");
        ...
        btn_transferir.setText("TRANSFER");
        ...
        btn_CambiarContraseña.setText("CHANGE PASSWORD");
        ...
        jlb_saldo.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jlb_saldo.setForeground(new java.awt.Color(255, 255, 255));
        jlb_saldo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlb_saldo.setText("0000 BS");
        ...
        jlb_MontoInicial.setText("Initial amount:");
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        ...
                        .addGap(29, 29, 29)
                        .addComponent(jlb_saldo, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        .addContainerGap()
        ...
        jPanel10Layout.setVerticalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jlb_saldo, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(17, 17, 17))
        );
        ...
        if (opcionTransferir) {
            if (esperandoNumeroCuenta) {
                ...
                if (cuentaDestino == null) {
                    JOptionPane.showMessageDialog(null, "Destination account number not found.");
                    return;
                }

                esperandoNumeroCuenta = false;
                jlb_cantidad.setText("");
                manejarSeleccionOpcion("[TRANSFER] Enter the amount to transfer.", false, false, false, true, false);
    ...
    private void jcb_movTipoCuentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcb_movTipoCuentaActionPerformed
        ...
        if (selectedIndex >= 0) {
            ...
            jlb_saldo.setText(String.valueOf(cuentaActual.getSaldoActual()));
        }
    ...
    private void btn_depositarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_depositarActionPerformed
        manejarSeleccionOpcion("[DEPOSIT] Enter the amount to deposit", true, false, false, false, false);
    ...
    private void btn_retirarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_retirarActionPerformed
        manejarSeleccionOpcion("[WITHDRAW] Enter the amount to withdraw", false, true, false, false, false);
    ...
    private void btn_ConsultarSaldoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ConsultarSaldoActionPerformed
        manejarSeleccionOpcion("[CHECK BALANCE]", false, false, true, false, false);
    ...
    private void btn_transferirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_transferirActionPerformed
        ...
        manejarSeleccionOpcion("[TRANSFER] Enter the account number to transfer.", false, false, false, true, false);
    ...
    private void realizarOperacion() {
        if (opcionDepositar) {
            ...
            JOptionPane.showMessageDialog(null, "Inquiry competed successfully.");
    ...
    private void realizarDeposito() {
        ...
        if (cuentaActual != null) {
            ...
            JOptionPane.showMessageDialog(null, "Deposit successfully competed.");
        ...
        try {
            ...
            if (cuentaActual != null && cuentaActual.getSaldoActual() >= cantidadTransferir) {
                ...
                if (cuentaDestino != null && cuentaDestino.getTipoMOneda() != null) {
                    ...
                    JOptionPane.showMessageDialog(null, "Transfer successfully completed.");
                } else {
                    JOptionPane.showMessageDialog(null, "Destination account number not found or null currency type.");
                }
            } else {
                JOptionPane.showMessageDialog(null, "Insufficient balance.");
            }
    ...
    private double convertirMoneda(double cantidad, String monedaOrigen, String monedaDestino) {
        ...
        // Definir tasas de conversión (estas son tasas ficticias, deberías obtener las reales de una fuente confiable)
    ...
    public void verificarCliente() {
        ...
        do {
            String identificador = JOptionPane.showInputDialog("Enter your identifier:");;
            if (identificador != null && !identificador.trim().isEmpty()) {
                identificador = identificador.trim();
                String contraseña = JOptionPane.showInputDialog("Enter your password:");
                if (contraseña != null && !contraseña.trim().isEmpty()) {
                    contraseña = contraseña.trim();
                    clienteActual = datos.buscarClientePorIdentificadorYContraseña(identificador, contraseña);
                    if (clienteActual != null) {
                        JOptionPane.showMessageDialog(null, "Client verified: " + clienteActual.getNombre());
                        mostrarCuentasCliente(clienteActual);
                        clienteEncontrado = true;
                    } else {
                        int opcion = JOptionPane.showOptionDialog(null, "Incorrect username or password. would you like to try again?", "Client not found", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, new String[]{"Yes", "No"}, "Yes");
                        if (opcion != JOptionPane.YES_OPTION) {
                            JOptionPane.showMessageDialog(null, "If you'renot a client yet, you can register.");
                            System.exit(0);
                        }
                    }
                } else {
                ...
                JOptionPane.showMessageDialog(null, "Invalid identifier. Please try again.");
            }
